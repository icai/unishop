<template>
<block v-if="diyitem.id == 'topmenu'">
  <view v-if="(topmenuDataType != 'stores' || topmenuDataType == 'goods') && topmenuDataType != ''" class="fui-goods-group block" style="background:#f3f3f3">
    <view v-for="(items, index) in diyitem.data" :key="index">
      <view class="fui-goods-item" v-for="(item, indexs) in items.data" :key="indexs">
  ...
  <view class="fui-tabbar-content" v-else-if="topmenuDataType == 'stores'">
    <view v-for="(items, index) in diyitem.data" :key="index">
      <view v-for="(item, indexs) in items.data" :key="indexs">
