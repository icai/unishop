<template>
<view class="seckill-group >" :style="'margin-top: ' + diyitem.style.margintop + 'px;'" v-if="diyitem.data">
    ...
    <navigator url="/seckill/pages/index/index">
            <view class="seckill-title">
                ...
                <view class="seckill-remark" :style="'color:' + diyitem.style.titlecolor + ';'"><span>更多</span><icon class="icox icox-qianjin-copy"></icon></view>
          ...
          <scroll-view scroll-x style="width: 100%">
            <view class="seckill-goods">
                ...
                <view class="item" v-for="(goods_item, index) in diyitem.data.goods" :key="index">
