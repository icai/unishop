    ...
    for (var i = 0; i < 42; i++) {
      ...
      if (i < firstKey - 1) {
        ...
        if (f < currentDayNum) {
          ...
          var date = Date.parse(currentdate.y + '/' + currentdate.m + '/' + currentdate.d); //第一天之前不可选择
          ...
          if ($this.data.isdelay == 1) {
            ...
            if ((date - checkedDate) % (interval * 86400000) == 0 && date < checkedDate + period_rest * interval * 86400000 && date > checkedDate) {
              checked = true;
            }
